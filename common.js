var common = (function()
{
    ...
    var uriBaseAnalyze = "v3.0/analyze";
    var uriBaseLandmark = "v3.0/models/landmarks/analyze";
    var uriBaseCelebrities = "v3.0/models/celebrities/analyze";
    var uriBaseThumbnail = "v3.0/generateThumbnail";
    var uriBaseOcr = "v1.0/ocr";
    var uriBaseHandwriting = "/v3.2/read/analyze";
